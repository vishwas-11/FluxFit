...
export default function Login() {
  ...
  useEffect(() => {
    ...
    // Debug: log exact origin so it can be added to GCP if 403 / "origin not allowed"
    const origin = typeof window !== "undefined" ? window.location.origin : "";
    if (import.meta.env.DEV && origin) {
      console.info(
        `[Google Sign-In] Ensure "${origin}" is in Authorized JavaScript origins. Use the "Web application" OAuth client.`
      );
    }
        ...
        <div className="backdrop-blur-xl bg-black/40 border border-white/10 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.6)] p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white tracking-wider mb-2">
              WELCOME <span className="text-[#00f3ff]">BACK</span>
            </h2>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            <p>
              ...
              <Link to="/register" className="text-[#00f3ff] hover:text-white transition-colors font-semibold">
                Sign Up
              </Link>
            </p>
          </div>
